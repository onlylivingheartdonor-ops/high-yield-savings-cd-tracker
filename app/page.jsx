      ...
      <main className="hys-wrap">
        ...
        <div className="hys-card">
          ...
          <div className="hys-disclaimer">
            This tool provides estimates for informational purposes only and does not constitute financial advice. Results assume a fixed interest rate for the full term. Actual earnings may vary based on rate changes, compounding method, and account terms. This site may use cookies and analytics. By using this site, you agree to our Privacy Policy and Terms of Service.
